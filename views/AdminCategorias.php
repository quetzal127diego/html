...
<html lang="en">
  ...
  <body>
            ...
            <nav class="nav justify-content-center navbar-dark bg-dark ">
              <a class="nav-link disabled" href="">Administrar Categoria</a>
              <?php
              session_start();
    ...
    <div class="container ">
            ...
            <div class="list-group ">
                <br><br>
                <hr>
                <a href='AgregarCategoria.php' class='list-group-item list-group-item-action flex-column align-items-start'>
                    <div class="d-flex w-100 justify-content-between">
                        <h5 class="mb-1">Agregar Categoria</h5>
                        <small><img src="../src/paginaimg/moda.png" alt="" width="20px"></small>
                    </div>
                    <p class="mb-1">Click aqui para agregar categoria</p>
                    <small></small>
                </a>
                <a href='ModificarCat.php' class='list-group-item list-group-item-action flex-column align-items-start'>
                    <div class="d-flex w-100 justify-content-between">
                        <h5 class="mb-1">Modificar Categoria</h5>
                        <small><img src="../src/paginaimg/ver.png" alt="" width="20px"></small>
                    </div>
                    <p class="mb-1">Click aqui para modificar categoria</p>
                    <small></small>
                </a>
